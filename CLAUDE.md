...
This is a **Claude Code plugin** — five OneKey wallet skills for on-chain
...
- `skills/` — five `SKILL.md` definitions (wallet, swap, market, security,
  hardware), each with its own `references/common.md`.
